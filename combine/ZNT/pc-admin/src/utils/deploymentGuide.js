export const DEPLOYMENT_MODES = [
  { id:'demo', title:'先看演示', description:'无需 GPU、模型、系统 Python 或 Node；保留八个预置案例。' },
  { id:'offline', title:'本地离线检测', description:'Qwen 在本机识图和报告，YOLO 初筛，SAM3 定位。' },
  { id:'cloud', title:'云端视觉 + 本地定位', description:'视觉模型使用 API；YOLO / SAM3 仍需本地 GPU 环境。' },
]
