        ...
        <a-form layout="inline" class="filter" :model="query">
          ...
          <a-form-item label="类型">
            <a-select v-model:value="query.type" allow-clear placeholder="全部" style="width: 140px">
              <a-select-option value="未戴安全帽">未戴安全帽</a-select-option>
              <a-select-option value="吊装违规">吊装违规</a-select-option>
              <a-select-option value="临边防护">临边防护</a-select-option>
              <a-select-option value="烟火违规">烟火违规</a-select-option>
            </a-select>
          </a-form-item>
          <a-form-item>
