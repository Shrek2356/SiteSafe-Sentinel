<template>
  ...
  <a-modal v-model:open="welcomeOpen" :footer="null" :width="800" :mask-closable="false" @cancel="dismissWelcome">
    <div class="welcome-guide">
      <div class="welcome-top"><span class="welcome-mark"><SafetyCertificateOutlined /></span><span class="eyebrow">SITESAFE SENTINEL / 快速开始</span></div>
...
const welcomeKey = () => `sitesafe_welcome_v12_${user.user?.id || user.user?.username || user.role}`
