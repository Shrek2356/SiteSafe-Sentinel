...
当前源码版本 **1.4.2**。保留桌面导出、工作空间备份恢复、模型部署向导和 Windows 安装包构建，补充规范证据链与全文索引。见[本版更新说明](../docs/桌面版v1.4.2更新说明.md)、[模型部署说明](../docs/桌面版v1.4.1模型部署说明.md)、[安装版说明](installer/安装版使用说明.md)与[版本记录](../../../CHANGELOG.md)。
