...
#endif
#define ProductGuid "{D8200384-F185-493C-B501-66A01C93F267}"
#define ProductName "筑安智巡 · SiteSafe-Sentinel"
...
AppPublisher=SiteSafe-Sentinel 项目团队
AppPublisherURL=https://github.com/Shrek2356/SiteSafe-Sentinel
AppSupportURL=https://github.com/Shrek2356/SiteSafe-Sentinel
VersionInfoVersion={#AppVersion}.0
VersionInfoDescription=SiteSafe-Sentinel 桌面软件安装程序
DefaultDirName={localappdata}\Programs\SiteSafe-Sentinel
DefaultGroupName=筑安智巡 SiteSafe-Sentinel
...
UninstallDisplayIcon={app}\SiteSafe-Sentinel.exe
UninstallDisplayName={#ProductName}
LicenseFile={#PayloadRoot}\LICENSE
InfoBeforeFile={#SourcePath}\安装前须知.txt
OutputDir={#OutputRoot}
OutputBaseFilename=SiteSafe-Sentinel_Setup_v{#AppVersion}_x64
Compression=lzma2/normal
SolidCompression=yes
AppMutex=Local\SiteSafeSentinelDesktop
...
Filename: "{app}\sitesafe-install.ini"; Section: "Setup"; Key: "AppId"; String: "{{D8200384-F185-493C-B501-66A01C93F267}"
Filename: "{app}\sitesafe-install.ini"; Section: "Setup"; Key: "Version"; String: "{#AppVersion}"

[Icons]
Name: "{group}\筑安智巡 SiteSafe-Sentinel"; Filename: "{app}\SiteSafe-Sentinel.exe"; WorkingDir: "{app}"; Comment: "工地开放风险识别与多 Agent 安全管理"
Name: "{group}\模型部署助手"; Filename: "{app}\部署助手.bat"; WorkingDir: "{app}"
Name: "{group}\打开软件目录与使用说明"; Filename: "{app}"; WorkingDir: "{app}"
Name: "{group}\卸载筑安智巡"; Filename: "{uninstallexe}"
Name: "{userdesktop}\筑安智巡 SiteSafe-Sentinel"; Filename: "{app}\SiteSafe-Sentinel.exe"; WorkingDir: "{app}"; Tasks: desktopicon

[Run]
Filename: "{app}\SiteSafe-Sentinel.exe"; Description: "立即打开筑安智巡（首次默认演示模式，不启动大模型）"; WorkingDir: "{app}"; Flags: nowait postinstall skipifsilent
