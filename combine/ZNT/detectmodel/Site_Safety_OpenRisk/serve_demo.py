...
class DemoStore:
    ...
    def __init__(self, data_dir: Path) -> None:
        ...
        self.response = CollaborativeResponseAgent(gateway=self.gateway)
        self.learning = ReviewLearningAgent(data_dir / "case_library.jsonl")
    ...
    def decide_confirmation(self, request_id: str, payload: dict) -> dict:
        ...
        if verdict == "confirmed":
            ...
            now = _now_iso()
            due_at = (
                datetime.now().astimezone() + timedelta(hours=SLA_HOURS[level])
