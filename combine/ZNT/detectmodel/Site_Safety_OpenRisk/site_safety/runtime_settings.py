...
SETTINGS_PATH = PROJECT_ROOT / "outputs" / "runtime" / "runtime_settings.json"
INITIAL_SETTINGS_PATH = PROJECT_ROOT / "configs" / "runtime_initial_settings.json"
...
DEFAULTS: Dict[str, Any] = {
    ...
    "sam3_enabled": True,
    "clip_enabled": False,
    "qwen_model_path": str(COMBINE_ROOT / "weights" / "Qwen3-VL-8B-Instruct-Q4_K_M.gguf"),
    "qwen_mmproj_path": str(COMBINE_ROOT / "weights" / "mmproj-BF16.gguf"),
    "qwen_base_url": "http://127.0.0.1:8080/v1/chat/completions",
    "sam3_repo_path": str(COMBINE_ROOT / "sam3-main"),
    "sam3_checkpoint_path": str(COMBINE_ROOT / "weights" / "sam3.pt"),
    "clip_checkpoint_path": str(Path.home() / ".cache" / "clip" / "ViT-L-14.pt"),
    "yolo_css_weights_path": str(COMBINE_ROOT / "yolo_site_workspace_portable" / "weights" / "yolo26m_css_v28_baseline_best.pt"),
    "yolo_construction_weights_path": str(COMBINE_ROOT / "yolo_site_workspace_portable" / "weights" / "yolo26m_construction_site_best.pt"),
}
