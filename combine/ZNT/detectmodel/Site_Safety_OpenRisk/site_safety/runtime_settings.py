...
DEFAULTS: Dict[str, Any] = {
    ...
    "yolo_css_weights_path": str(APP_ROOT / "models/yolo/yolo26m_css_v28_baseline_best.pt"),
    "yolo_construction_weights_path": str(APP_ROOT / "models/yolo/yolo26m_construction_site_best.pt"),
}
