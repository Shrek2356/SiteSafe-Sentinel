...
class TrainingFreeInspector:
    ...
    def inspect(
        ...
        if self.config["pipeline"].get("two_stage_open_discovery", False):
            ...
            first_prompt = build_first_pass_prompt(
                candidate_risks,
                allow_open_discovery=bool(
                    self.config["risk_catalog"].get("allow_open_discovery", True)
                ),
        ...
        active_risks = [
            ...
            if risk.status in segment_statuses and risk.confidence >= min_conf
        ]
    ...
    def _append_screening_views(
        ...
        *,
        ...
        labels = list(manifest or ["Image 1: original full construction-site image"])
    ...
    def _run_combined_second_pass(
        ...
        evidences: List[RiskEvidence],
            ...
            image_manifest = ["Image 1: original construction-site image"]
    ...
    def _run_per_risk_second_pass(
        ...
        for evidence in evidences:
            ...
            raw = self.mllm.generate_json(
                second_images,
                build_second_pass_prompt(evidence_payload, image_manifest),
            )
    ...
    def _build_first_pass_images(
        ...
        manifest = ["Image 1: original full construction-site image"]
